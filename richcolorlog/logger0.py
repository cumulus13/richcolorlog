...
class RichColorLogFormatter(CustomFormatter):
    ...
    def __init__(
        ...
        """
        Initialize RichColorLogFormatter.
        
        Args:
            fmt (str, optional): Format string (supports %(log_color)s and %(reset)s)
            datefmt (str, optional): Date format string
            show_background (bool): Whether to show background colors
            show_time (bool): Whether to show timestamp
            show_name (bool): Whether to show logger name
            show_pid (bool): Whether to show process ID
            show_level (bool): Whether to show log level
            show_path (bool): Whether to show file path
        """
        super().__init__(
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        """
        # If user provided a format string, inject color codes
        ...
        # Otherwise use CustomFormatter behavior
        return super().format(record)
